...
public class BlockEntityRegistry {
    ...
    public static final RegistryObject<BlockEntityType<TeaBrewingMachineBlockEntity>> TEA_BREWING_MACHINE =
            BLOCK_ENTITIES.register("tea_brewing_machine", () -> BlockEntityType.Builder.of(
                    TeaBrewingMachineBlockEntity::new, BlockRegistry.TEA_BREWING_MACHINE.get()).build(null));
}
