...
public class StarlightCoffeeMachineScreen extends AbstractContainerScreen<StarlightCoffeeMachineMenu> {

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(KachuDelight.MOD_ID, "textures/gui/starlight_coffee_machine_gui.png");

    public StarlightCoffeeMachineScreen(StarlightCoffeeMachineMenu menu, Inventory inventory, Component title) {
