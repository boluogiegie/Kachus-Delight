...
public class StarlightCoffeeMachineCategory implements IRecipeCategory<CoffeeRecipe> {
    public static final RecipeType<CoffeeRecipe> STARLIGHT_COFFEE_MACHINE_TYPE =
            RecipeType.create(KachuDelight.MOD_ID, "coffee_brewing", CoffeeRecipe.class);

    private static final ResourceLocation TEXTURE =
            new ResourceLocation(KachuDelight.MOD_ID, "textures/gui/starlight_coffee_machine_gui.png");
    ...
    public StarlightCoffeeMachineCategory(IGuiHelper helper) {
    ...
    public RecipeType<CoffeeRecipe> getRecipeType() {
        return STARLIGHT_COFFEE_MACHINE_TYPE;
    }
